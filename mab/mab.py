...
class EXP3:
    def __init__(self, arms, gamma):
        """
        Initialize the EXP3 algorithm.

        :param arms: Number of arms (k).
        :param gamma: Exploration parameter (0 < gamma <= 1).
        """
        self.arms = arms
        self.gamma = gamma
    ...
    def run(self, arm_probs, iterations):
        ...
        for itr in range(iterations):
            ...
            reward = fuzz_run(str(itr), chosen_probs)
...
if __name__ == "__main__":
    ...
    exp3 = EXP3(arms=args.arms, gamma=args.gamma)
